...
public class User implements UserDetails {
    ...
    public boolean isAccountNonExpired() {
        return isState(state, "A");
    }

    // 잠긴 계정
    @Override
    public boolean isAccountNonLocked() {
        return isState(state, "L");
    }

    // 패스워드 만료
    @Override
    public boolean isCredentialsNonExpired() {
        return isState(state, "P");
    }
    ...
    private boolean isState(String state, String stateType) {
        return !StringUtils.equalsIgnoreCase(state, stateType);
    }
}
